    ...
    public static class EnchantmentEquipped {
        ...
        public static void doStuff(final LivingHurtEvent event){
            ...
            if(event.getSource().getTrueSource() instanceof LivingEntity) {
                ...
                int level = EnchantmentHelper.getEnchantmentLevel(ModEnchantments.LIGHTNING.get(), source.getHeldItemMainhand());
                if(level >= ModEnchantments.LIGHTNING.get().getMinLevel()) {
