...
public class PoisonEnchantment extends Enchantment {
    public PoisonEnchantment(Rarity rarityIn, EquipmentSlotType... slots){
    ...
    public static class EnchantmentEquipped {
        ...
        public static void doStuff(final LivingHurtEvent event){
            ...
            if(event.getSource().getTrueSource() instanceof LivingEntity) {
                ...
                int level = EnchantmentHelper.getEnchantmentLevel(ModEnchantments.POISON.get(), source.getHeldItemMainhand());
                if(level >= ModEnchantments.POISON.get().getMinLevel()) {
