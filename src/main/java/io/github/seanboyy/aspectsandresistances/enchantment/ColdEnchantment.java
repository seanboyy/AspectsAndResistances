...
public class ColdEnchantment extends Enchantment {
    public ColdEnchantment(Rarity rarityIn, EquipmentSlotType... slots){
    ...
    public static class EnchantmentEquipped {
        ...
        public static void doStuff(final LivingHurtEvent event){
            ...
            if(event.getSource().getTrueSource() instanceof LivingEntity) {
                ...
                int level = EnchantmentHelper.getEnchantmentLevel(ModEnchantments.COLD.get(), source.getHeldItemMainhand());
                if(level >= ModEnchantments.COLD.get().getMinLevel()) {
