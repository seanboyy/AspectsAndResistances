...
public class WitherAspectEnchantment extends Enchantment {
    public WitherAspectEnchantment(Rarity rarityIn, EquipmentSlotType... slots) {
    ...
    public static class EnchantmentEquipped {
        ...
        public static void doStuff(final LivingHurtEvent event) {
            ...
            if(event.getSource().getTrueSource() instanceof LivingEntity) {
                ...
                int level = EnchantmentHelper.getEnchantmentLevel(ModEnchantments.WITHER_ASPECT.get(), source.getHeldItemMainhand());
                if (level >= ModEnchantments.WITHER_ASPECT.get().getMinLevel()) {
