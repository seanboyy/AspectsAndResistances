    ...
    public static class EnchantmentEquipped {
        ...
        public static void doStuff(final LivingHurtEvent event) {
            ...
            if(event.getSource().getTrueSource() instanceof LivingEntity) {
                ...
                int level = EnchantmentHelper.getEnchantmentLevel(Enchantments.WITHER_ASPECT.get(), source.getHeldItemMainhand());
                if (level >= Enchantments.WITHER_ASPECT.get().getMinLevel()) {
