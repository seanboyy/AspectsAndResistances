...
public class LightningAspectEnchantment extends Enchantment {
    public LightningAspectEnchantment(Enchantment.Rarity rarityIn, EquipmentSlotType... slots) {
    ...
    public static class EnchantmentEquipped {
        ...
        public static void doStuff(final LivingHurtEvent event){
            ...
            if(event.getSource().getTrueSource() instanceof LivingEntity) {
                ...
                int level = EnchantmentHelper.getEnchantmentLevel(ModEnchantments.LIGHTNING_ASPECT.get(), source.getHeldItemMainhand());
                if(level >= ModEnchantments.LIGHTNING_ASPECT.get().getMinLevel()) {
